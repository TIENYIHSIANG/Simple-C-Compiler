  ...
  while (1)
  {
    ...
    else
    {
      ...
      case '#':
        ...
        s[n]='\0';
        advance();
        return newSymbol(symHEAD,linenum,cp,s);
      case ';':
        s[n++]=nextChar;
        s[n]='\0';
        advance();
      ...
      case '+':
        ...
        if (nextChar=='+')
        {
        	s[n++]=nextChar;
          	advance();
          	s[n]='\0';
        	return newSymbol(symINC,linenum,cp,s);
		}
		else
		{
      ...
      case '-':
        ...
        if (nextChar=='-')
        {
        	s[n++]=nextChar;
          	advance();
          	s[n]='\0';
        	return newSymbol(symDEC,linenum,cp,s);
		}
		else
		{
      ...
      case '/':
        ...
        if (nextChar=='/')
        {
        	s[n++]=nextChar;
          	advance();
          	s[n]='\0';
        	return newSymbol(symCOMMENT,linenum,cp, s);
		}
		else
		{
      ...
      case '<':
        ...
        else if (nextChar=='<')
        {
          ...
          advance();
          s[n]='\0';
          return newSymbol(symSHL,linenum,cp,s);
        }
        else
        {
      ...
      case '>':
        ...
        else if (nextChar=='>')
        {
          ...
          advance();
          s[n]='\0';
          return newSymbol(symSHR,linenum,cp,s);
        }
        else
        {
      ...
      case '|':
        ...
        if (nextChar=='|')
        {
          ...
          advance();
          s[n]='\0';
          return newSymbol(symLOR,linenum,cp, s);
        }
        else
        {
      ...
      case '&':
        ...
        if (nextChar=='&')
        {
          ...
          advance();
          s[n]='\0';
          return newSymbol(symLAND,linenum,cp, s);
        }
        else
        {
      ...
      case '^':
        ...
        s[n]='\0';
        advance();
        return newSymbol(symXOR,linenum,cp,s);
      case '%':
        s[n++]=nextChar;
        s[n]='\0';
        advance();
